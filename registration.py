...
image2 = image2.resize((800, 720), Image.ANTIALIAS)
...
l1 = tk.Label(window, text="Registration", font=("Times", 30), bg="white", fg="skyblue3")
l1.place(x=245, y=50)

# that is for label1 registration

l2 = tk.Label(window, text="Name", width=15, font=("aerial", 15), bg="snow")
...
l3 = tk.Label(window, text="Address", width=15, font=("aerial", 15), bg="snow")
